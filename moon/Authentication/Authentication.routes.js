...
router.get('/getuser', Authentication_middleware_1.Authenticated, auth.getUser);
...
router.post('/changePassword', Authentication_middleware_1.Authenticated, auth.changePassword);
router.post('/updateUser', Authentication_middleware_1.Authenticated, auth.updateProfile);
router.delete('/deleteUser', Authentication_middleware_1.Authenticated, auth.deleteAccount);
